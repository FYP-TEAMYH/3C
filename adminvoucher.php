                                ...
                                <div class="panel-body">
                                    <div class="table-responsive"> <a href="adminaddvoucher.php"><input type="submit" value="Add Voucher" name="add" class="btn btn-primary" style="background-color:#DAA520 ;width:20em; margin:0;"></a><br><br>
                                        <table class="table table-striped table-bordered table-hover" id="">
                                            ...
                                            <tbody>
                                            <?php 
                                            $query=mysqli_query($con,"select * from coupon ORDER BY id ASC ");
                                            while($row=mysqli_fetch_array($query)){?>
                                                <tr>
                                                    ...
                                                    <?php
                                                        if($row['status']==1){
                                                            echo "<span class='badge badge-complete' style='color:black;text-align: center;background-color:#32CD32;'><a href='?type=status&operation=deactive&id=".$row['id']."'>Active</a></span>";
                                                        }else{
                                                            echo "<span class='badge badge-pending' style='color:black;text-align: center;background-color:#FF8C00;'><a href='?type=status&operation=active&id=".$row['id']."'>Deactive</a></span>";
                                                        }
                                                    ?></td><td style="text-align: center;"><?php
                                                    echo "<span class='badge badge-edit'style='text-align: center;background-color:#DAA520;' ><a href='manage_coupon_master.php?id=".$row['id']."'>  Edit  </a></span>";
                                                    ?></td><td style="text-align: center;"><?php
                                                    echo "<span class='badge badge-delete'style='text-align: center;background-color:#B22222;' ><a href='?type=delete&id=".$row['id']."'>  Delete  </a></span>";
                                                    ?></td>
                                                    </tr>
